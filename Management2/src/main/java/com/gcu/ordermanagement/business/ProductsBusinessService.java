...
public class ProductsBusinessService implements productsBusinessServiceInterface {
	...
	public List<Product> getProducts() {
		...
		for(ProductEntity entity : productsEntity) {
			productsDomain.add(new Product(entity.getProductId(), entity.getProductName(), entity.getProductDescription(), entity.getProductPrice(), entity.getProductQuantity()));
		}
